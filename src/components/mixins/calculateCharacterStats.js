  ...
  methods: {
    calculateCharacterStats: function (character) {
      switch (character.gender) {
        ...
        default: console.log('Oh my fucking god! Something went wrong with your gender!')
      }
      switch (character.background) {
        ...
        case 'Mystic': character.stats.strength += 1; character.stats.dexterity += 0; character.stats.intelligence += 3; break
        default: console.log('Oh my fucking god! Something went wrong with your background!')
      }
      switch (character.class) {
        ...
        default: console.log('Oh my fucking god! Something went wrong with your class!')
      }
    }
  }
}
